...
- Notes:
  - `ka`, `Ma`, and reference years may locate intervals within a Galactic
    Cycle, while cultures may retain their own calendars.
  - Galactic Cycles are chronological units, not synchronized civilizational
    cycles.
  - No universal event-graph format is required.
  - The epoch, nominal cycle length, and coordinates of known eras remain
    unresolved until the master timeline is populated.
