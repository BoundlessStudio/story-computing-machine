...
- Aliases: None
- Notes:
  - Many distinct systems exist. They may interact, hybridize, imitate one
    another, or share ancestry, but no single origin explains every anomaly.
  - Systems commonly called magic are genuinely real and may exist independent
    of what a culture calls technology. They may substitute for, reproduce, or
    combine with systems another culture describes as technology.
  - Different systems need not be active in every era.
...
- Notes: Nonliving devices may store, focus, transmit, or shape magic supplied
  ...
  alive. Whether a constructed mind, god, organism, or artifact is alive must
...
- Aliases: Godhood
- Notes:
  - `God` and `godhood` are the project's taxonomy for beings that satisfy this
    conjunction; the label does not imply a separate divine substance.
  - Losing all belief or worship ends godhood. Belief alone cannot create a god
    without power and authority and does not generally rewrite a god's nature.
  - Authority may be granted, taken, or rarely assumed as a mantle.
  - Power may be lost, taken, or given, but transfer constraints are not yet
    defined and not every being can participate.
  - Origin, including construction, neither grants nor disqualifies godhood.
  - Gods may be constrained by laws and costs, dependence on worship, domain or
    authority, contracts, institutions, peers, and rivals. No universal divine
    government spans all eras and systems. Recurring divine constraints must
    remain compatible with this shared framework.
...
- Notes: Ghosts, reincarnation, and digitally mediated continuations are also
  ...
  coherently by the systems and stories that use them.
...
- Aliases: None
- Notes:
  - Some power may be genuinely free. Every power must still obey its own
    established system.
  - Consent has no single universal metaphysical behavior. A recurring system
    must treat its relationship to consent consistently, and stories must take
    the ethical consequences seriously.
...
- Aliases: None
- Notes:
  - Similar memory-like patterns may appear across substrates without proving a
    universal memory substance or access to the same layer of a person.
...
- Aliases: None
- Notes:
  - Dreams, predictions, alternate-timeline traces, mythologized history, and
    similar explanations must be established and causally coherent.
  - Altered records can become propaganda, dogma, or oppression.
  - Artifacts may be honest but misread, propagandistic, self-altering, or able
    to preserve unusual testimony when a relevant system supports that behavior.
    No artifact is automatically decisive.
  - Across sufficient time, material becomes dust, testimony becomes memory,
    memory becomes myth and legend, and the original referent may be forgotten.

## Portals and crossing systems
...
- Notes:
  - Directionality, access, limits, and paradox behavior belong to each
    recurring system.
  - The Glass Gate is one local system connecting eras of the same world.
...
- Aliases: None
- Notes:
  - Treat major artifacts as products of separate systems and civilizations
    unless specific evidence establishes a relationship.
  - Sun, moon, glass, copper, and other recurring images may be motifs without
