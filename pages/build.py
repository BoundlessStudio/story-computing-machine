...
def render_index(stories: list[Story]) -> str:
  ...
  <main class="library">
    ...
    <p class="collection-count">{len(stories)} stories · {total_words:,} words</p>
    <ul class="story-grid">
{chr(10).join(cards)}
    </ul>
  </main>
  <footer class="site-footer">
    <p>Built automatically from each publishable <code>stories/*/05-story.md</code>.</p>
  </footer>"""
...
def main() -> None:
    ...
    print(
        f"Built {len(stories)} story pages in {args.output.resolve()} "
