...
| `the-courtesy-of-blades` | *The Courtesy of Blades* | candidate | no | — | Rival fencers settle a disputed 3–2 self-call through a nonlethal courtesy bout, then freely begin their date; certified PASS; proposed canon delta not promoted. |
...
| `the-last-thing-i-could-fix` | *The Last Thing I Could Fix* | candidate | no | — | Coercive plot-armor harness redesigned into consent-bound three-rivet protection; spillgate rescue certified PASS; proposed canon delta not promoted. |
...
| `the-quiet-party` | *The Quiet Party* | candidate | no | — | Three video-game-style silent protagonists flawlessly recover the guild seal from Barrowglass; revised final certified PASS; proposed canon delta not promoted. |
...
| `the-thirteenth-command` | *The Thirteenth Command* | candidate | no | — | Civilian dispatch experience applied as Level 13 Combat Controller; voluntary Common Cause during a cistern assault certified PASS; proposed canon delta not promoted. |
...
| `the-wrong-side-of-the-part` | *The Wrong Side of the Part* | candidate | no | — | Personality-inverting wig and family-shop reckoning certified PASS; proposed canon delta not promoted. |
