# Proposed canon delta — All Accounts Due
...
registry row, lifecycle record, or release decision is changed by this delta.

## Canon posture

The final prose presents one wholly standalone terminal-era event in which six
distinct magical systems exhaust every kind of magic active in the present
material world. The event is undated and geographically unplaced relative to
all admitted stories. It names no admitted character, location, artifact,
institution, title, system, crisis, or historical episode, and it establishes
no crossover or shared origin.

The story's terminal claim is exact but bounded. Living capacity, active
workings, stored charge, magical structures, material-world crossing anchors,
faculties, hybrids, reserves, relics, inheritance, recoverable patterns, and
every material restoration possibility end permanently. Earlier history
remains real. The prose makes no claim about the universal afterlife, other
realities, earlier eras, alternate timelines, or destinations beyond closed
material-world crossings.

The Ithrom Array, eight relics, six sockets, world-curves, and terminal
junction are non-character mechanisms. Living authorities arm the six
system-specific conditions while magic is active. Faris's spoken declaration
supplies witness, not power; his ordinary cotter pull releases the already
...
- **AAD-01 — Faris (proposed).** **Fact:** Faris is a man who has never had
  ...
  **Constraints and dependencies:** His lack is not severance, dormancy,
  immunity, prophecy, destiny, genius, combat mastery, magical authority, or a
  universal non-user capability. Fire, gravity, command surfaces, falls,
  debris, and injury affect him normally. His success depends on AAD-02 through
  AAD-07, AAD-09 through AAD-36, and his deliberate deception in AAD-36.
  **Provenance:** `05-story.md`, opening, all six flashbacks, the Unwritten
  Axis crossing, and the cotter release. **Proposed disposition:** `PROPOSE
  ADD`. **Suggested smallest topical target:** `universe/characters.md`.
...
- **AAD-03 — Hurzai (proposed).** **Fact:** Hurzai is a demon lord who uses
  ...
  **Provenance:** `05-story.md`, Ghorvane flashback, fourth arming, and
...
- **AAD-04 — King Malrec (proposed).** **Fact:** King Malrec's heartbeat
  ...
  AAD-24, and AAD-32 through AAD-35. **Provenance:** `05-story.md`, Mavorn
  flashback, second arming, defense, and extinction wave. **Proposed disposition:** `PROPOSE ADD`. **Suggested smallest topical target:**
...
- **AAD-05 — Qeluun (proposed).** **Fact:** Qeluun is a vast living nonhuman
  ...
  body, personhood, relationship with Faris, and Worldcoil actions in this
  story. **Constraints and dependencies:** Qeluun is not a landscape, battery,
  planet, generic cosmic species, or universal gravity source. The prose does
  not establish their death, survival, afterlife, or relationship to another
  vast being. Depends on AAD-12, AAD-20, AAD-25, and AAD-32 through AAD-35.
  **Provenance:** `05-story.md`, Aphalion flashback, third arming, defense,
  and extinction wave. **Proposed disposition:** `PROPOSE ADD`. **Suggested smallest topical target:** `universe/characters.md`.

- **AAD-06 — Jelveth Sorn (proposed).** **Fact:** Jelveth Sorn is a keeper of
  ...
  every altered body. Depends on AAD-14, AAD-21, AAD-27, AAD-28, and AAD-32
  through AAD-35. **Provenance:** `05-story.md`, Keruvan flashback, fifth
  arming, defense, and extinction wave. **Proposed disposition:** `PROPOSE
  ADD`. **Suggested smallest topical target:** `universe/characters.md`.

- **AAD-07 — Ekkorath (proposed).** **Fact:** Ekkorath is a dragon who uses
  they/them pronouns and Horizon Flight. At Skairrift they spend bodily
  ...
  culture, route system, or relationship to any admitted dragon. Depends on
  AAD-15, AAD-18, AAD-29, AAD-30, and AAD-32 through AAD-35.
  **Provenance:** `05-story.md`, Skairrift flashback, sixth arming, and final
  corridor. **Proposed disposition:** `PROPOSE ADD`. **Suggested smallest
  topical target:** `universe/characters.md`.

- **AAD-08 — Faris's six relationships and renewed choices (proposed).**
  **Fact:** Seyathi, Malrec, Qeluun, Hurzai, Jelveth, and Ekkorath each retain
...
- **AAD-11 — Mavorn Palace prison and pardon (proposed).** **Fact:**
  Twenty-four years before the Array event, nine prison wings occupy one
  foundation at Mavorn Palace under King Malrec's heartbeat. Faris enters as a
  laundry porter to steal the Sole Chamber, follows the wrong scratch, escapes
  a cell by tracking repeated ordinary smells with an unnamed prisoner's help,
  steals the Chamber, and warns Malrec of an assassin instead of escaping.
  Malrec survives, the prison settles to one arrangement with captives alive,
  and he later pardons Faris while retaining the public-decision condition.
  **Exact local scope:** Mavorn Palace, this prison configuration, theft,
  warning, and pardon. **Constraints and dependencies:** No wider kingdom,
  legal code, prison history, or later institutional outcome is established.
  Depends on AAD-04, AAD-19, and AAD-24. **Provenance:** `05-story.md`,
  Mavorn flashback. **Proposed disposition:** `PROPOSE ADD, LOCALLY BOUNDED`.
  **Suggested smallest topical target:** `universe/timeline.md`.

- **AAD-12 — Aphalion Belt poacher rescue (proposed).** **Fact:** Fourteen
  years before the Array event, poacher rigs drill into Qeluun's exposed
  sensory tissue in the Aphalion Belt. Faris brings back a stolen shed
  vertebra, cuts the tether holding him instead of a rig, is caught by Qeluun,
  and follows their pressure knocks to pry open physical clamps while Qeluun
  accepts further injury to help him. He returns the bone; Qeluun entrusts it
  back for one terminal alignment. **Exact local scope:** This injury,
  poaching incident, rescue, and entrusted custody on Qeluun's body.
  **Constraints and dependencies:** The poachers, buyer, law, wider Belt, and
  recurrence remain unnamed and unresolved. Depends on AAD-05, AAD-20, and
  AAD-25. **Provenance:** `05-story.md`, Aphalion flashback. **Proposed disposition:** `PROPOSE ADD, LOCALLY BOUNDED`. **Suggested smallest topical
  target:** `universe/timeline.md`.

- **AAD-13 — Ghorvane Underforge coup rescue (proposed).** **Fact:**
  Thirty-one years before the Array event, a root-furnace coup traps demon
  young after usurpers seal the air shutters. Faris follows ordinary airflow,
  mistakenly opens a slag hatch, releases a half-forged predator, receives
  Hurzai's rescue, passes an artifact vault, and cranks the true shutter until
  Hurzai can complete the opening. The young survive and identify coup
  participants; Hurzai later bargains Cold Maw custody and one root act.
  **Exact local scope:** This one Underforge coup, furnace, rescue, and bargain.
  **Constraints and dependencies:** No wider demon realm, coup outcome,
  government, species-wide practice, or afterlife connection is established.
  Depends on AAD-03, AAD-17, and AAD-26. **Provenance:** `05-story.md`,
  Ghorvane flashback. **Proposed disposition:** `PROPOSE ADD, LOCALLY
  BOUNDED`. **Suggested smallest topical target:** `universe/timeline.md`.
...
- **AAD-14 — Keruvan Fold sanctuary breach and bargain (proposed).** **Fact:**
  ...
  while she stabilizes bodies. His retained written orders expose the patrons;
...
## New systems, capabilities, and limits

- **AAD-16 — Tessellate Grace (proposed).** **Fact:** Tessellate Grace lets
  living Seyathi and prepared mineral geometry impose bodily arrangement,
  shelter, healing alignment, direction, and compulsion on prepared surfaces.
  A prepared blank underside can act despite lacking visible lines. Seyathi's
  use can temporarily damage her spatial sense; breaking an ordinary
  maintenance connection can interrupt one bounded pattern. Its Missing
  Tessera keystone reaches its active surfaces, capacities, stored patterns,
  and derivatives during the synchronized terminal event. **Exact local scope:**
  Tessellate Grace as demonstrated at Talarum and the Array in this terminal
  era. **Constraints and dependencies:** No origin, universal geometry rule,
  effect away from prepared surfaces, or relationship to another magic system
  is established. A mundane seam defeating one pavement is not a universal
  anti-magic method. Depends on AAD-02, AAD-10, AAD-23, AAD-22, and AAD-34.
  **Provenance:** `05-story.md`, Talarum and extinction scenes. **Proposed disposition:**
  `PROPOSE ADD WITH SYSTEM-LOCAL QUALIFIERS`. **Suggested smallest topical target:**
  `universe/rules.md`.

- **AAD-17 — Inward Fire (proposed).** **Fact:** Living demons can consume
  ...
  structures in this story. **Constraints and dependencies:** No universal
  demon ontology, afterlife relation, survival outcome, fuel law, or shared
  origin is established. Depends on AAD-03, AAD-13, AAD-26, AAD-22, and
  AAD-34. **Provenance:** `05-story.md`, Ghorvane, terminal defense, and
  extinction scenes. **Proposed disposition:** `PROPOSE ADD WITH SYSTEM-LOCAL
  QUALIFIERS`. **Suggested smallest topical target:** `universe/rules.md`.

- **AAD-18 — Horizon Flight (proposed).** **Fact:** Living dragons use flight
  circuits that bend distance, make destinations falsely adjacent, sustain sky
  corridors, and suspend structures. Physical ballast and falling stone can
  still reveal ordinary down on grounded material inside a distorted route.
  ...
  crossing network. Depends on AAD-07, AAD-15, AAD-29, AAD-22, and AAD-34.
  **Provenance:** `05-story.md`, Skairrift and extinction scenes. **Proposed disposition:**
  `PROPOSE ADD WITH SYSTEM-LOCAL QUALIFIERS`. **Suggested smallest topical target:**
  `universe/rules.md`.
...
- **AAD-19 — Manyroom (proposed).** **Fact:** King Malrec's heartbeat lets
  ...
  and AAD-34. **Provenance:** `05-story.md`, Mavorn, terminal defense, and
  extinction scenes. **Proposed disposition:** `PROPOSE ADD WITH SYSTEM-LOCAL
  QUALIFIERS`. **Suggested smallest topical target:** `universe/rules.md`.

- **AAD-20 — Worldcoil (proposed).** **Fact:** Qeluun's living bodily
  ...
  category, or shared origin is established. Depends on AAD-05, AAD-12,
  AAD-25, AAD-22, and AAD-34. **Provenance:** `05-story.md`, Aphalion,
  terminal defense, and extinction scenes. **Proposed disposition:** `PROPOSE
  ADD WITH PERSONHOOD AND SYSTEM-LOCAL QUALIFIERS`. **Suggested smallest topical target:**
  `universe/rules.md`.

- **AAD-21 — Kindred Graft (proposed).** **Fact:** Kindred Graft lets living
  participants exchange bounded bodily faculties under a living keeper. The
  story shows chosen sense, breath, muscle, and shared-heart functions as well
  as forced grafts; material supports can temporarily brace a habitat when a
  ...
  `PROPOSE ADD WITH PERSONHOOD AND SYSTEM-LOCAL QUALIFIERS`. **Suggested smallest topical target:**
  `universe/rules.md`.

- **AAD-22 — exhaustive six-system terminal inventory (proposed).** **Fact:**
...
## Eight nonliving relics

- **AAD-23 — Missing Tessera (proposed).** **Fact:** Missing Tessera is a
  nonliving matte mineral tile made for Seyathi two hundred and thirty-three
  years before the Talarum rescue. It contains one finite direction of her
  grace, is freely given to Faris after the rescue with Seyathi retaining the
  arming act, and must be placed blank-side inward. At the Array, Seyathi arms
  it against the Absolute Yoke; synchronized discharge ends Tessellate Grace
  and reduces the tile to ordinary powder. **Exact local scope:** This one
  keystone, its custody, finite pattern, and Tessellate Grace adapter.
  **Constraints and dependencies:** The prose does not name its maker, grant it
  agency, let Faris arm it, or let it affect another system independently. It
  retains no recoverable pattern. Depends on AAD-02, AAD-10, AAD-16,
  AAD-30 through AAD-36. **Provenance:** `05-story.md`, Talarum, first
  arming, and extinction. **Proposed disposition:** `PROPOSE ADD`.
  **Suggested smallest topical target:** `universe/rules.md`.

- **AAD-24 — Sole Chamber (proposed).** **Fact:** Sole Chamber is a nonliving,
  thumb-sized bronze model made by Mavorn's first palace architects four
  ...
  **Constraints and dependencies:** It does not duplicate people, choose an
  ...
  Depends on AAD-04, AAD-11, AAD-19, AAD-30 through AAD-35.
  **Provenance:** `05-story.md`, Mavorn, second arming, defense, and
  extinction. **Proposed disposition:** `PROPOSE ADD`. **Suggested smallest topical target:**
  `universe/rules.md`.

- **AAD-25 — Nearmost Vertebra (proposed).** **Fact:** Nearmost Vertebra is a
  nonliving porous bone segment shed by Qeluun ninety-seven years before Faris
  ...
  AAD-12, AAD-20, AAD-30 through AAD-35. **Provenance:** `05-story.md`,
  Aphalion, third arming, and extinction. **Proposed disposition:** `PROPOSE
  ADD`. **Suggested smallest topical target:** `universe/rules.md`.

- **AAD-26 — Cold Maw (proposed).** **Fact:** Cold Maw is a nonliving pair of
  ...
  **Constraints and dependencies:** It does not burn, choose, speak, protect
  ...
  reserve. Depends on AAD-03, AAD-13, AAD-17, AAD-30 through AAD-35.
  **Provenance:** `05-story.md`, Ghorvane, fourth arming, defense, and
  extinction. **Proposed disposition:** `PROPOSE ADD`. **Suggested smallest topical target:**
  `universe/rules.md`.

- **AAD-27 — Unhatched Form (proposed).** **Fact:** Unhatched Form is a
  nonliving organoid shaped by six former keepers one hundred and forty-one
  years before the Keruvan theft. It stores possible exchanges but has never
  ...
  AAD-14, AAD-21, AAD-30 through AAD-35. **Provenance:** `05-story.md`,
  Keruvan, fifth arming, and extinction. **Proposed disposition:** `PROPOSE
  ADD WITH NONPERSON QUALIFIER`. **Suggested smallest topical target:**
  `universe/rules.md`.
...
- **AAD-28 — Mortal Latch (proposed).** **Fact:** Mortal Latch is a nonliving
  ...
  **Provenance:** `05-story.md`, Keruvan, Axis crossing, cotter release, and
  extinction. **Proposed disposition:** `PROPOSE ADD`. **Suggested smallest
  topical target:** `universe/rules.md`.

- **AAD-29 — Unflown Arc (proposed).** **Fact:** Unflown Arc is a nonliving
  ...
  AAD-15, AAD-18, AAD-30, and AAD-32 through AAD-35.
  **Provenance:** `05-story.md`, Skairrift, sixth arming, and extinction.
  **Proposed disposition:** `PROPOSE ADD`. **Suggested smallest topical
...
- **AAD-30 — Parity Astrolabe (proposed).** **Fact:** Parity Astrolabe is a
  ...
  **Exact local scope:** This one six-system instrument, recovery, and
  terminal synchronization. **Constraints and dependencies:** It is not a
...
- **AAD-31 — Bound Ascendancy and Absolute Yoke (proposed).** **Fact:** The
  ...
  HYBRID-NOT-SEVENTH-SYSTEM QUALIFIER`. **Suggested smallest topical target:**
...
- **AAD-33 — ordinary cotter release and declaration (proposed).** **Fact:**
  ...
  Unwritten Axis. **Constraints and dependencies:** The declaration is
  witnessed choice, not spell, true-name effect, command, authority, magical
  fuel, hidden Faris faculty, or reusable terminal phrase. Depends on AAD-01,
  AAD-09, AAD-22 through AAD-32, and enables AAD-34.
  **Provenance:** `05-story.md`, final Axis crossing and declaration.
  **Proposed disposition:** `PROPOSE ADD WITH NONMAGICAL-WORDS QUALIFIER`.
  **Suggested smallest topical target:** `universe/timeline.md`.

- **AAD-34 — permanent end of present-material-world magic (proposed).**
  **Fact:** The simultaneous terminal wave ends all six systems and every
  constituent hybrid in distinct physical grammars. It empties living
  capacity, active workings, stored charge, standing magical structure,
  material-world crossing anchors, bestowed and species faculties, hybrid
  function, reserves, relics, seeds, inheritable potential, and every
  ...
  **Exact local scope:** The present material world from this terminal instant
  forward. **Constraints and dependencies:** Earlier history is unchanged.
  The event makes no claim about the universal afterlife, earlier eras,
  alternate timelines, other realities, or destinations beyond closed
  material-side anchors. Depends on AAD-16 through AAD-33.
  **Provenance:** `05-story.md`, six-part extinction wave and Array collapse.
  **Proposed disposition:** `PROPOSE ADD, TERMINAL-ERA WORLDWIDE`.
  **Suggested smallest topical target:** `universe/timeline.md`.

- **AAD-35 — personhood and material outcomes of extinction (proposed).**
  **Fact:** Extinction does not erase identity, memory, relationships, scars,
  grief, worship, responsibility, or earlier consequences. Every god loses
  ...
  AAD-16 through AAD-22, and AAD-34. **Provenance:** `05-story.md`,
  extinction wave and Seyathi endpoint. **Proposed disposition:** `PROPOSE
  ADD WITH PERSONHOOD AND BIOLOGY QUALIFIERS`. **Suggested smallest topical
  target:** `universe/rules.md`.

- **AAD-36 — Faris's narrow promise and Seyathi's betrayal (proposed).**
  **Fact:** Faris asks Seyathi: `Arm the Missing Tessera, and before this hour
  ends the Absolute Yoke will be powerless. I will not take its power, wear it,
  ...
  **Constraints and dependencies:** This is ordinary deliberate deception and
  a technically fulfilled narrow promise, not magical contract enforcement,
  consent obtained by wording, absolution, a joke, or proof Seyathi lacks a
  valid moral claim. The story ends before response, punishment, explanation,
  reconciliation, or aftermath. Depends on AAD-02, AAD-10, AAD-16, AAD-23,
  AAD-32 through AAD-35. **Provenance:** `05-story.md`, Talarum lesson,
  first arming, and exact terminal paragraphs. **Proposed disposition:**
  `PROPOSE ADD WITH UNINFORMED-CHOICE QUALIFIER`. **Suggested smallest
  topical target:** `universe/timeline.md`.

## Final character-facing inventory:

- **Faris** — Reserved forms: `Faris`; pronouns: he/him
- **Seyathi** — Reserved forms: `Seyathi`; pronouns: she/her
- **Hurzai** — Reserved forms: `Hurzai`; pronouns: he/him
- **Ekkorath** — Reserved forms: `Ekkorath`; pronouns: they/them
- **King Malrec** — Reserved forms: `King Malrec`; `Malrec`; pronouns: he/him
- **Qeluun** — Reserved forms: `Qeluun`; pronouns: they/them
- **Jelveth Sorn** — Reserved forms: `Jelveth Sorn`; `Jelveth`; pronouns: she/her

This inventory is exhaustive for the final prose. Pilgrims, the unnamed
prisoner, guards, an assassin, poachers and their buyer, demon young, usurpers,
patrons, sanctuary residents, former keepers, engineers, soldiers, conscripted
mouths, gods, worshippers, dragons other than Ekkorath, demons other than
Hurzai, kings other than Malrec, and every other crowd or role remain unnamed.
No named animal, username, separate living construct, person-like relic,
honorific, nickname, additional title-as-name, or crossover identity appears.

## Reviewed prose name-audit allowlist

| Candidate label | Classification | Review rationale |
| --- | --- | --- |
| `Ithrom Array`; `Array` | structure | Reviewed in final prose; these forms name one nonliving stone-and-metal terminal assembly, not a person or personified machine. |
| `Unwritten Axis`; `Axis` | structure | Reviewed in final prose; these forms name the Array's nonliving manual recess, not a person or autonomous judge. |
| `Absolute Yoke`; `Yoke` | coercive hybrid structure | Reviewed in final prose; this is a six-system coercive hybrid using conscripted mouths and borrowed faculties, not a separately named living character or seventh source. |
| `Bound Ascendancy`; `Ascendancy` | opposition collective | Reviewed in final prose; this is the named attacking opposition and its collective manifestation, not a separate personal name. |
| `Talarum Steps`; `Talarum` | place | Reviewed in final prose; this is the local name of the Grace-pavement quest site. |
| `Mavorn Palace`; `Mavorn` | place | Reviewed in final prose; this is the local name of Malrec's palace and prison complex. |
| `Aphalion Belt`; `Aphalion` | place | Reviewed in final prose; this is the local name of the upper-air region around Qeluun's injured body. |
| `Ghorvane Underforge`; `Ghorvane` | place | Reviewed in final prose; this is the local name of the root-furnace quest site. |
| `Keruvan Fold`; `Keruvan` | place | Reviewed in final prose; this is the local name of the graft-sanctuary quest site. |
| `Skairrift` | place | Reviewed in final prose; this is the local name of the corridor-knot quest site. |
| `Tessellate Grace`; `Grace` | magical system | Reviewed in final prose; these forms refer to Seyathi's prepared-surface system, not a person or deity alias. |
| `Inward Fire` | magical system | Reviewed in final prose; this is the local system name for living demon-supplied inward-burning fire. |
| `Horizon Flight` | magical system | Reviewed in final prose; this is the local system name for dragon flight circuits and bent distance. |
| `Manyroom` | magical system | Reviewed in final prose; this is the local system name for Malrec's overlapping structural arrangements. |
| `Worldcoil` | magical system | Reviewed in final prose; this is the local system name for Qeluun's weight-altering bodily faculty, not an alias for Qeluun. |
| `Kindred Graft`; `Graft` | magical system | Reviewed in final prose; these forms refer to bounded living faculty exchange, not a person or collective. |
| `Missing Tessera`; `Tessera` | nonliving relic | Reviewed in final prose; this is Seyathi's matte mineral keystone, never a person. |
...
| `No More Magic` | quoted-text | Reviewed in final prose; this is Faris's witnessed declaration accompanying an ordinary cotter pull, not a character, spell name, or magical command. |
| `end function; preserve matter`; `Preserve matter. End function.` | engraved-text | Reviewed in final prose; these are mechanical selector instructions on Mortal Latch, not a person or magical command. |
| `SELL IT. COULD HAVE.`; `OURS. NOT NEEDED. SHED.`; `END US?` | quoted dialogue | Reviewed in final prose; these capitalized fragments are Qeluun's pressure-speech, not names for additional characters or entities. |
...
- **AAD-37 — terminal-era proper-noun bundle (proposed).** **Fact:** Candidate
  ...
  **Constraints and dependencies:** These terms do not imply character status,
  ...
  term, or reusable command power. Short forms are only the final prose's local
  references to their listed full labels. Depends on AAD-09 through AAD-31.
  **Provenance:** `05-story.md`, complete proper-noun inventory. **Proposed disposition:** `PROPOSE ADD ONLY IF USEFUL WITH LOCAL QUALIFIERS`.
  **Suggested smallest topical target:** `universe/glossary.md`.

## Name registry updates

The final forms are exactly those in the final character-facing inventory and
match the current in-progress registry reservations. Ekkorath uses they/them in
every final-prose reference, while Faris uses he/him. There is no deliberate
reuse and no additional form to register. This file does not edit
`stories/NAMES.md`; final reconciliation remains coordinator-owned.

## Possible conflicts or retcons

None identified. All facts are proposed with exact story-local or
terminal-era scope. They preserve six unrelated systems, living magical
agency, nonliving artifact limits, personhood, a terminal chronology after
earlier magic-active histories, Teen treatment, and the present-material-world
boundary. They imply no crossover, shared origin, retroactive erasure,
afterlife extinction, universal dragon or demon rule, surviving magic, or
authorized retcon.
...
- Recheck current `LOCKED` and `CANON` authority at promotion time,
  including whether any later-admitted magic-active story changes the required
  terminal placement.
- Give every AAD item an explicit final disposition; rejected items remain
  recorded rather than silently omitted.
- Preserve the exact local qualifiers, six-system independence, living-agency
  dependencies, nonliving relic limits, personhood outcomes, and
  present-material-world boundary in every accepted item.
- Place the event only after all admitted material-world histories in which
  magic remains active; do not add a public date or crossover without separate
  authority.
- Promote an accepted fact only into its listed smallest topical target with
  provenance to `stories/all-accounts-due/05-story.md`.
- A conflict with current `LOCKED` canon requires a user ruling. This delta
  does not authorize reinterpretation, retcon, or promotion.

## Recommended promotions

None at this stage. All thirty-seven reusable-fact entries remain proposed,
authority remains `none`, the story remains a non-canon in-progress pipeline
artifact, and no promotion is authorized or performed by this delta.
