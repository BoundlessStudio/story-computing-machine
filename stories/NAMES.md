...
| Ruva | `Ruva` | `the-healers-measure` | in-progress | unique | No reuse. Adult healer and witchknight apprentice; distinct in full spelling, sound, cadence, and role from reserved `Ruth`, `Ruvik`, `Rana`, `Rae`, `Rhea`, `Ryo`, `Rose`, and `Veda`. Final prose uses only `Ruva`, with no surname, nickname, title-plus-name, epithet, or alternate form. |
