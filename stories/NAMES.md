...
| Ruva | `Ruva` | `the-healers-measure` | in-progress | unique | No reuse. Adult healer and witchknight apprentice; distinct in full spelling, sound, cadence, and role from reserved `Ruth`, `Ruvik`, `Rana`, `Rae`, `Rhea`, `Ryo`, `Rose`, and `Veda`. Planned prose uses only `Ruva`, with no surname, nickname, title-plus-name, epithet, or alternate form. |
...
| Vekran | `Vekran` | `the-healers-measure` | in-progress | unique | No reuse. Adult veteran witchknight and Ruva's mentor; distinct in full spelling, sound, cadence, and role from reserved `Varkesh`, `Veda`, `Kelan`, `Kest`, `Kethra`, `Kezli`, and `Harven`. Planned prose uses only `Vekran`, with no surname, nickname, title-plus-name, epithet, or alternate form. |
