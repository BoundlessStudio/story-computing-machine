...
| Naomi Basto | `Naomi Basto`; `Naomi` | `the-sky-remembers-us` | in-progress | unique | No reuse. Adult Earth systems ecologist and close-third protagonist; `Basto` is not used alone. Both forms are distinct in spelling, sound, reversal, and role from every current reservation. |
...
| Veyru | `Veyru` | `the-sky-remembers-us` | in-progress | unique | No reuse. Adult living envoy and bridge for one bounded repair compact; final prose is planned to use only the mononym, with `envoy` remaining a common role noun. Distinct from Vekran, Varkesh, Veda, Yara, Ruva, and Ryo in spelling, sound, and role. |
