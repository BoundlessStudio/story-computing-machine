...
| Dorram | `Dorram` | `voice-of-silence` | in-progress | unique | No reuse. One chief examiner and living shaper/caller; `chief examiner` and `examiner` remain lowercase role descriptions, and no surname, nickname, or proper-title form is planned. |
...
| Kethra | `Kethra` | `voice-of-silence` | in-progress | unique | No reuse. Mute callwright protagonist and archmage candidate; `archmage`, `shaper`, and `candidate` remain lowercase roles, and no surname, nickname, or proper-title form is planned. |
...
| Ulan | `Ulan` | `voice-of-silence` | in-progress | unique | No reuse. One living caller and colleague; `caller` remains a lowercase role description, and no surname, nickname, or proper-title form is planned. |
