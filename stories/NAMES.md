...
| Kezli | `Kezli` | `the-five-minute-warranty` | in-progress | unique | No reuse. Planned goblin lead engineer; distinct in full spelling and cadence from reserved Kelan, Kest, and Kethra. No surname, nickname, proper title, or alternate form is planned. |
...
| Nalda Vick | `Director Nalda Vick`; `Nalda Vick`; `Director Vick`; `Nalda` | `the-five-minute-warranty` | in-progress | unique | No reuse. Planned human lift director; all forms identify one person. `Director` alone and `the director` remain common role descriptions, and `Vick` is not used alone. Distinct from reserved Nell, Nessa, Nilo, Nina, Vicar Estrel, and Varkesh. |
...
| Olbit | `Olbit` | `the-five-minute-warranty` | in-progress | unique | No reuse. Planned goblin loadwright; distinct in spelling and cadence from Olyra, Oren, Orrin, and Osket. No surname, nickname, proper title, or alternate form is planned. |
