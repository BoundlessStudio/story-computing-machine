...
| Bosk | `Bosk` | `clerics-infernal-ex` | in-progress | unique | No reuse. Adult human bard; the clipped form is distinct in spelling, sound, cadence, and role from registered Bash, Baird, Bexel, Bracken, Mossback, and Osket. Final prose uses only `Bosk`, with no surname, nickname, stage name, proper title, or alternate form. |
...
| Udren | `Udren` | `clerics-infernal-ex` | in-progress | unique | No reuse. Adult human shield fighter; distinct in initial, spelling, sound, cadence, and role from registered Ulan, Urumet, Deryn, Oren, Orrin, and Trenn. Final prose uses only `Udren`, with no surname, nickname, proper title, or alternate form. |
