...
| Bosk | `Bosk` | `clerics-infernal-ex` | in-progress | unique | No reuse. Adult human bard; the clipped form is distinct in spelling, sound, cadence, and role from registered Bash, Baird, Bexel, Bracken, Mossback, and Osket. Final prose is planned to use no surname, nickname, stage name, proper title, or alternate form. |
...
| Dorram | `Dorram` | `voice-of-silence` | in-progress | unique | No reuse. Final prose uses only `Dorram` for the chief examiner and living shaper/caller; `chief examiner` and `examiner` remain lowercase roles, and no surname, nickname, or proper-title form appears. |
...
| Emet Sarn | `Emet Sarn`; `Emet` | `clerics-infernal-ex` | in-progress | unique | No reuse. Adult human cleric and viewpoint character; distinct in spelling, sound, cadence, and role from registered Eiren, Eli, Ekri, Estrel, Salken, and Sorel. `Sarn` is not planned for use alone, and no proper clerical title, nickname, or alternate form is planned. |
...
| Lacrixa | `Lacrixa` | `clerics-infernal-ex` | in-progress | unique | No reuse. Adult living demon and Emet's former partner; the four-syllable form and `-crixa` ending distinguish it from registered Larkspur, Letha, Luz, Cassia, Draxenne, and Irix. Final prose is planned to use no surname, shortening, epithet, proper title, or alternate form. |
...
| Udren | `Udren` | `clerics-infernal-ex` | in-progress | unique | No reuse. Adult human shield fighter; distinct in initial, spelling, sound, cadence, and role from registered Ulan, Urumet, Deryn, Oren, Orrin, and Trenn. Final prose is planned to use no surname, nickname, proper title, or alternate form. |
