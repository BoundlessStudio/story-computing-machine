...
| Luz Navarro | `Luz Navarro`; `Luz` | `life-with-a-girlfriend-with-shrinking-powers` | in-progress | unique | No reuse. Adult shrinking girlfriend and active operator of her locally bounded ability; `Navarro` is not used alone. `Luz` is distinct in spelling, cadence, and role from registered Ludo, Lumen, Letha, and other L-initial forms. |
...
| Miles Arden | `Miles Arden`; `Miles` | `life-with-a-girlfriend-with-shrinking-powers` | in-progress | unique | No reuse. Adult non-shrinking viewpoint partner; `Arden` is not used alone. Both forms are distinct in spelling, cadence, and role from every active or reserved registry form. |
