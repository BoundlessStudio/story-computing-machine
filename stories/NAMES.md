...
| Cody | `Cody` | `transitions-in-common` | in-progress | unique | No reuse. Sixteen-year-old first-person shapeshifter who uses one stable name and they/them pronouns across masculine, feminine, and mixed human forms; no surname, nickname, form-name, username, title, or alternate spelling is planned. Distinct from every current reservation in exact form, spelling, sound, reversal, and role. |
...
| Hugo | `Hugo` | `transitions-in-common` | in-progress | unique | No reuse. Sixteen-year-old transgender boy and Cody's friend; no surname, nickname, username, title, deadname, or alternate spelling is planned. Distinct from registered Hadrik, Harven, Hester, Havil, Highway, and all other reservations in spelling, sound, length, reversal, and role. |
