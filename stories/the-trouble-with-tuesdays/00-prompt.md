...
> Story slug: `the-trouble-with-tuesdays`
> Captured: 2026-07-22
...
- Working title: The Trouble With Tuesdays
- Target length: 3,000–4,000 words
- POV: Preserve the source story's most effective viewpoint unless canon research requires a change
- Tense: Preserve the source story's dominant tense
- Tone and genre: Playful speculative fiction with escalating consequences and a satisfying cycle
...
- Creative input: `sources/records/s08/The Trouble With Tuesdays.md` (complete short story with a cyclical hook).
