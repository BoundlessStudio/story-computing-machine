...
- Imported seed: legacy source `S07`
- Portable snapshot: `stories/_legacy/imports/s07/The_Small_Moon_Rose_First_Full_Outline.md`
- Source form: full 40-chapter novel outline
...
- Required elements: Treat the imported outline as creative starting material and preserve its provenance
- Prohibited elements: Treating source lore as established universe canon or this snapshot as `02-story-plan.md`

## Assumptions

- This request initializes the story at prompt stage; it does not request the full `[WP]` workflow.
- The outline is nonbinding and must be reconciled against `universe/` before reuse.
- The outline's novel-length target does not set the eventual production story length without a later user decision.
...
- The source is clearly labeled as a legacy seed rather than a production plan, draft, final story, or canon.
...
- `05-story.md` is a complete, polished story rather than a copied legacy outline.
