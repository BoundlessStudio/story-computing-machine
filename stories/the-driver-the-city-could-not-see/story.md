---
title: "The Driver the City Could Not See"
slug: "the-driver-the-city-could-not-see"
created: 2026-08-20
created-at: 2026-08-20T08:42:41-04:00
canon: false
---
...
Kaith Muir felt the sequence through the cab's steering column. On wet nights the amber chord came up through the floor a fraction late. The system measured the lag and corrected for it. She knew because the wheel nudged her scarred palm just before the taxis crossed.

Then the curb-call slot clanked behind her.
...
The depot microphone accepted her voice, found no question addressed to city service, and did nothing.
...
Kaith's transponder chimed once, expecting a declared load. The curb bar still showed one.
...
"And if we make the ferry?"

Arovi showed four roads branching from the opposite bank. None carried a destination label.
...
Two images: the service cradle and the ferry. Between them Arovi placed an open hand. The hand turned toward the ferry.

Outside, green light traveled down the manual lane. A low pavement note offered Kaith a seventeen-second entrance into the braid.

She put the route strip in the dash clip. "Close enough."

The cab joined the city.

For the first kilometer, the road made room for her.

Kaith's transponder declared a licensed manual vehicle, one human driver, commercial equipment within the permitted mass band, western quay route. The choir answered in colored allowances. White edge lights widened when she drifted near a freight lane. Amber rippled beneath her tires before an automated taxi merged across her nose. Blue bars marked a delivery convoy whose braking distance the city would not negotiate.

Kaith steered between the signals instead of obeying them. That was why tourists sometimes hired her in daylight. They wanted to watch hands make the decisions a road had already made. They photographed the brass license plate behind her seat. Once, a child had asked whether the wheel was ceremonial.

Tonight the wheel pulled left as the cab's rear suspension took Arovi's weight.

Kaith corrected before the lane noticed. "Move six centimeters right."

Arovi shifted precisely six centimeters. The pull eased.

"Next time, move before I ask."

Arovi was watching the light crawl over the rear window, measuring something Kaith could not see.

Ahead, the pavement turned violet.

Kaith swore and downshifted. Violet meant a dynamic weigh strip, temporary tonight; the city had moved it out of a freight lane to make room for resurfacing. The route display built a pale corridor around the cab. There was no legal turn before the strip.

"We're going to be heavier than I declared. If you have a useful picture, now."

The dashboard flashed with the cab seen from above. Four small squares marked its wheels. Numbers gathered over the rear axle, too many. Arovi added three objects: jack, tire chains, tool chest. The jack moved forward. The chains split left and right. The tool chest stayed where it was.
...
"Declared commercial mass variance," said a neutral voice. "Enter verification bay. Maintain cabin visibility."

Kaith let irritation into her answer; irritation was expected from her. "Yes, I heard you. It's a replacement differential, and it sits like a pig because my lift case cracked. You can inspect the manifest at the quay."

"Enter verification bay. Maintain cabin visibility."

Arovi's hand struck the seat rail: two taps, pause, one.

On the dashboard, the jack moved forward again.

"I can't move it while driving."
...
"Temporary commercial variance accepted. Proceed to quay verification."

The restraint arms stayed down.
...
Kaith snorted. That, at least, was an answer no tourist had ever given her.

The western lanes narrowed after the market towers. Rain thickened, turning every color into a second road on the glass. The traffic choir shed its heavy freight notes and rose into quick silver pulses: close vehicles, short gaps, no tolerance for uncertain motion. Kaith kept one hand light on the wheel and one near the shifter. The cab could not match the silent acceleration of the automated stream, so she used its changes of shape—entered behind a bus as three taxis lifted away, held a delivery bike's wake, crossed two lanes where green light traveled diagonally like a thrown net.

Arovi stopped projecting whenever an exterior optic turned toward them. Her darkness acquired rhythm. Picture, blackout, picture. Kaith learned to wait through missing parts.
...
The arrow remained. Above it, Arovi drew the tunnel as two mirrored planes. Her projector beam struck one and multiplied into a dozen red rings.
...
"I lost it," she said. "No light. Again."

Arovi tapped, but the glass tunnel swallowed the cab and changed every sound.

Reflections sprang around them: headlamps, lane bars, their own pale faces doubled to infinity. Arovi pulled her hood across her features and stayed still. The dashboard remained dead.
...
Arovi tapped four times against the rail, paused, twice. Distance meant nothing without a unit. Six seconds? Six light bars? Kaith watched the sweep ahead. It moved one support column per second.

"Show me. Low."

Blue light bloomed under Arovi's cupped hands, hidden below the window line. A crude plan spread over Kaith's knuckles: cab, scan bars, open door. Beyond the open door, Arovi's figure stood inside a white ring. The loop entered her head and returned blank.

Beside it Arovi drew a second choice. A fuse came out of the dashboard. All lane colors vanished. The cab became a black block between streams of moving light. At the far edge, the ferry flashed once, then disappeared behind a stack of narrowing bars.

Arovi held both choices there. She did not put the open hand on either one.

The scan advanced another column.

Kaith looked at the paper route strip. Once she disappeared from the network, putting the fuse back would not mend the journey. The transponder would report a dark interval, and the cab's grandfathered registration would freeze pending review. Her license might remain as a line in a database, but the car was the license's only surviving use. Home, work, brass plate, tourists asking about the ceremonial wheel—all of it ended at a fuse no bigger than her thumbnail.

The wheel nudged her palm. The city was correcting her toward the center of the scan lane.

Kaith corrected back.

"Hold the wheel straight," she said.

Arovi leaned forward and gripped it from behind, one hand below each of Kaith's. Her touch was careful and very strong.

Kaith reached under the dash, tore down the breaker cover, and found the transponder fuse by feel. She hooked it with the tips of her pliers.

The scan bars reached the car ahead.

She pulled.

Every lane light assigned to the cab went black.

The steering wheel kicked as Arovi released it. Around them, automated vehicles opened emergency distance from an unclassified obstruction. Brakes flashed in cascading blue. The pavement struck one blunt alarm note that Kaith felt in her teeth.

"Unrecognized road hazard," the city said from speakers outside the cab. "Stop in place."
...
At the tunnel exit, Arovi risked the projector. A blue arrow appeared low across Kaith's right wrist. Kaith followed it around a braking taxi and into the wake of a municipal carrier.

Another arrow flashed left too soon.
...
"Vehicle identity required," said the gate. "Stop in place."
...
Kaith rolled onto the grade.

The windshield filled with concrete. She could no longer see the front corners of the cab. Arovi stopped projecting and put both hands flat on the floor.

One tap came up under Kaith's left foot. She turned half a hand and eased forward.

Two taps under her right heel. Straighten.

The left rear wheel dropped into a washout. The cab tilted, door frame groaning. Kaith held the brake at the edge of lock. Arovi struck a rapid pattern beneath the center of the seat, then a single blow to the right.
...
No city voice followed them onto the river. The pavement choir faded first to a tremor, then to nothing. Kaith's hands kept expecting the wheel to warn her. It did not.

Arovi pushed back her hood.
...
Kaith took the paper route strip from the dash clip. Its printed line ended at the quay behind them. She turned it over and drew three quick bends on the blank side with a grease pencil: fuel, south, east.

Arovi looked from the new line to Kaith. The open hand appeared once on the dashboard.

Kaith put the cab in gear as the ferry met the far bank.
