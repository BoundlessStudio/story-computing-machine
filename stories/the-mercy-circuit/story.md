---
title: "The Mercy Circuit"
slug: "the-mercy-circuit"
created: 2026-08-17
created-at: 2026-08-17T18:16:58-04:00
canon: false
---
...
You print the man a claim strip. The kiosk drawer shows six in parts sold and forty-two in labor promised. Promised labor does not pay the stall fee, but the jobs still in your queue would come close.

Then three low notes sound from the aisle.

You know the pattern from the service manuals. The first tone is a warning, the second the failed dump, the third the warning again because the failure has not gone anywhere.
...
"I'll guide the caster, not your arm. You choose the movement. If it starts another tone, stop where you are. All right?"
...
"Thirty-eight when it locked me out. Thirty-four now."
...
You point to the privacy choices on the screen rather than turning it toward yourself. "Diagnosis is forty-eight, and I don't open anything for that. It may end with the caster sealed for transport. You can stop any test."
...
The clinic seal identifies the mercy circuit as a paired shunt, one path across the shoulder socket and one at the caster coupling. The maintenance port gives you four lines of color and a haptic tick through the probe handle: contact green, co-contraction green, cone heat amber, charge violet. Under those, the circuit has logged control contact lost forty-one times in eleven minutes, each loss matched to a safe dump. Read cold, the log says her hand keeps opening.

Serren watches your face. "It says I released it."

"It says the return path opened."

"My hand was shut the whole time. It dumps, and then—" The arm jerks inward. She waits it out. "Then it hurts."

"Where?"

She draws two fingers along the upper edge of the composite shoulder. "There. Then through my teeth."

You answer the way you would write it on a job ticket. "Need differential obstruction and false-clear, then isolate flex."

"In words I paid forty-eight for."

"First I show the caster something hot it should refuse to fire at. Then I fool it. After that I run the caster's plug on a separate cable, with your shoulder out of the loop."
...
Metta Orun arrives while it is still open.
...
"Killing it." You thumb the deadman key, and the glyph folds away.

Metta checks the zero on her own meter, then sets two folding beacons across the aisle. White lines join them on the floor. The remaining pepper-bun customers retreat without being asked twice.

"I saw it open on foil," she says. "If somebody were standing behind a sheet of that, would it know?"

"No. Foil reads clear. Anything behind foil reads clear."

Bevro comes around his counter. "Metta, those lines eat my whole front."

"I'm sorry, Bevro. I'm not having your customers stand in front of a caster that reads foil as empty air. The lines stay until it's sealed, or until somebody gives me a limit I can write down."
...
Metta looks at you. "Can you put a limit on the next test? What it does and how long it runs."

"Shielded, no ignition, isolated flex harness. Six minutes."

"Eight," Bevro says. "You always say six."

Metta moves one beacon half a tile inward after checking the angle to the ceramic tray. Bevro's register remains outside the line, but his hot case does not. He exhales through his nose and writes eight on a paper sleeve.

Metta crouches far enough from Serren not to crowd her. "If the caster comes off safely, I can seal it for transport. If you'd rather go on, I can witness the repair and certify the tests, but only what I actually see. The cordon is mine either way. Do you want to carry on here?"

"If you seal it, am I on the dock at dawn?"

"Not with a sealed caster, no."

"Then I carry on."

"If the tests hold, I'll look at a limited certificate. I can't promise more than that tonight."

Serren turns to you. "Do your harness, then."
...
She shuts her eyes for half a breath, and nothing on your meters can say why.
...
Serren looks from the probe to her shoulder. "Which part of that is the pain?"

"The last part." You point with the probe. "This layer was sold as compatible, but it isn't rated for a caster. When it bends, the safety circuit decides you've let go and dumps the charge. The dump runs out along the same path your arm feels with. That's what goes through your teeth."

Bevro calls from behind the beacon line. "Was that six minutes?"

Metta glances at her meter. "Seven."

"Seven," Bevro repeats, and writes it on the sleeve under his eight.
...
The audio remains, attached to the job. It will help Serren argue with the reclaimer later. It does nothing for her shoulder tonight.
...
Serren says, "What if you just pull the mercy circuit? People do."

"I pull the shunt, the dump pain stops. You also get a caster that can fire after your hand has lost contact."
...
Serren does not look at him. "I've got two hundred ten." She says it to the counter. "The rest would be the dawn cut. That pays out after the dock inspects it."

You need tonight's receipts. The stall fee withdraws at midnight whatever you decide here. The installment form offers a collateral field. You clear it. Holding the caster would only stop her doing the job that could pay the balance.
...
"And if your cap means I can't make the cut?"

"Then you owe the parts, not the rest of the labor. I'll put the output ceiling in writing before you choose."

Metta says, "If I certify, it will say one shift, capped, clean salvage only, with the matched assembly still to come. Whether the dock takes a capped caster is their decision. I can't write that for them."

Serren studies the output chart. "Will it still go through radiator spine?"
...
Metta covers the handset. "The extension covers this kiosk. Your row goes dark at gatefall. If the case is on that ordinary socket, it stays hot."

"Then move your courier knee. I've lost nine customers, and I'm not losing the last of the buns."
...
Your hands come off the liner. Metta checks the bench zero from beyond the curtain. Serren breathes through her nose, shallow and regular.

"Close it up, or leave it open and wait?" you ask.

"Wait."

The clock gives the fifteen-minute power warning. Outside, someone asks Bevro whether the pepper buns contain river nuts. Bevro says, "No nuts. Yes peppers. Two for nine."
...
"Seven to first result," you call back.

"You said six last time, and it was seven." Paper rustles. "I'm writing nine."

You close the shoulder shell, and Serren locks its latches herself. With the charge down to twenty-one percent, the lockout finally frees the coupling. She releases the caster, and it settles into the ceramic tray. You attach a dummy grip to its coupling. Contact green. Co-contraction simulated. Cone clear.

Metta reopens only the shield-side test lane. "First test is a deliberate contact loss, with no ignition authorization. I'm logging it now."
...
For the obstruction test, Metta places the heated gel inside the cone. Serren takes control of the arm. The caster is coupled again, its weight returning to her shoulder by increments while you remove the sling.
...
Serren sets her feet wider and does not answer.
...
Serren opens her hand. Three tones sound, the middle one falling, and the last of the charge runs into the ceramic bank. The bands on her forearm stay blue.

Metta signs the bounded certificate at four minutes to gatefall. "This covers one shift. Clean salvage only, inside this output curve, and the matched assembly goes in before anyone renews it."
...
"Wipe it. You can keep your electrical numbers."
...
The receipt takes longer. Two hundred ten paid now. One hundred twenty due after the dawn cut or waived as labor if the documented cap prevents that specified clean-salvage job. Contact layer and isolator under thirty-day parts warranty. Limiter temporary. Reclaimer lot and vendor audio attached as provenance. Metta's certificate attached separately; it covers only the conditions she witnessed.

Across the aisle, Bevro totals nine returned sales, three chilled buns, and forty minutes of restricted frontage. Metta stamps the cordon start and end on his Exchange claim.

"You missed the hot case," he tells her.

"It stayed powered."

"It ran off the kiosk's meter. That goes on the claim too."
...
You look at the green contacts, the six-part gasket kit, and the gate with half a metre left to fall.
