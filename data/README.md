...
- `prompt-scout/` stores prompt rankings, deduplication IDs, explicit feedback,
  taste evidence, scan archives, and calibration history shared by the
  `prompt_scout` and `prompt_calibrator` agents.
